...
(0, _jquery2.default)(html_app2).appendTo((0, _jquery2.default)("#app2"));
(0, _jquery2.default)("#app2>.tab-bar").on("click", "li", function (e) {
  var $li = (0, _jquery2.default)(e.currentTarget);
  $li.addClass("selected").siblings().removeClass("selected");
  var index = $li.index();
  (0, _jquery2.default)("#app2>.tab-content").children().eq(index).addClass("active").siblings().removeClass("active");
});

//进页面先自动设置一个触发，否则用户不点击前看不到首页有什么
(0, _jquery2.default)("#app2>.tab-bar").children().eq(0).trigger("click");
...
(0, _jquery2.default)(html_app3).appendTo((0, _jquery2.default)("#app3"));

(0, _jquery2.default)(".square").on("click", function () {
  (0, _jquery2.default)(".square").toggleClass("active");
});
...
(0, _jquery2.default)(html_app4).appendTo((0, _jquery2.default)("#app4"));
...
},{"./global.css":"global.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"..\\..\\..\\..\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '62422' + '/');
...
//# sourceMappingURL=/main.875bd8c9.map